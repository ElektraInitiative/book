...
\begin{frame}<2-7>[label=learn from system administration]
...
\againframe<1,99>{learn from system administration}
...
\begin{frame}
	\frametitle{Outlook}
	Office hour today 16:00.

	\vspace{1cm}

	How ``everything'' in CM connects in L10:
	\begin{itemize} %[<+-| alert@+>]
	\item documentation
	\item introspection
