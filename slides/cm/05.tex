...
\begin{frame}<2-4>[label=configuration management tools]
	\frametitle{Definition}
...
\againframe<1,99>{configuration management}
...
\againframe<1,99>{configuration management tools}

%%%%%%%%%%%
\breakframe

\againframe<1,99>{possible benefits}

\againframe<1,99>{design rules}

\againframe<1,99>{precise editing}
