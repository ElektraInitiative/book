...
\begin{frame}
	...
	Next lectures:
	\begin{description}
		\item[23.3.2018:] last lecture before eastern
		\item[13.4.2018:] first lecture after eastern
...
\begin{frame}
	...
	\begin{itemize}
	\item \formatdate{3}{11}{1971}
	\item passwd, group use :
...
\begin{frame}
	...
	\item configuration files the most chaotic but the only persistent one
	\end{itemize}
\end{frame}
