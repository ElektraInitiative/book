...
\begin{frame}
	...
	\begin{description}
		...
		\item[13.03.2019:] {\color{red} registration, initial PR}
...
\begin{frame}
	...
	\item[7] context-aware % configuration
	...
	\item[1] convention % over configuration
	\item[1] CI/CD
...
\begin{frame}
	...
	\begin{itemize}
	\item PR must be done today, can be trivial
	\item why is the homework so individual?
	\item more about which issues
	\item https://github.com/orgs/ElektraInitiative/teams/cm2019s
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item The duration must be not longer than 20 minutes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Understanding Elektra's abstraction that deals with this issue.
	\end{itemize}
\end{frame}
